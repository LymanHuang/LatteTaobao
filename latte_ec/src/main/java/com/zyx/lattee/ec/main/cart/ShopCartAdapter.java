...
public class ShopCartAdapter extends MultipleRecyclerAdapter {
    ...
    private ICartIemListener mCartItemListener = null;
    ...
    protected ShopCartAdapter(List<MultipleItemEmity> data) {
        super(data);
        //初始化总价
    ...
    public void setCartItemListener(ICartIemListener listener) {
        this.mCartItemListener = listener;
    }

    @Override
    protected void convert(MultipleViewHolder holder, final MultipleItemEmity entity) {
        switch (holder.getItemViewType()){
            case ShopCartItemType.SHOP_CART_ITEM:
                ...
                final AppCompatTextView tvPrict = holder.getView(R.id.tv_item_shop_cart_price);
                ...
                tvDesc.setText(desc);
                tvPrict.setText(String.valueOf(price));
                ...
                //添加左侧勾勾点击事件   注意这里的onclicklistener最好不要写在类里。
                ...
                iconMinus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (Integer.parseInt(tvCount.getText().toString()) > 1){
                            RestClient.builder()
                                    .url("http://www.youec.cc/apptest/shop_cart_count.php")
                                    .loader(mContext)
