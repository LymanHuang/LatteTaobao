...
import com.zyx.latte_ui.animation.BezierAnimation;
import com.zyx.latte_ui.animation.BezierUtil;
import com.zyx.latte_ui.banner.HolderCreator;
import com.zyx.latte_ui.widget.CircleTextView;
...
public class GoodsDetailDelegate extends LatteDelegate implements AppBarLayout.OnOffsetChangedListener, BezierUtil.AnimationListener {
    ...
    void onClickAddShopCart() {
        final CircleImageView aninImg = new CircleImageView(getContext());
        Glide.with(this)
                .load(mGoodsThumbUrl)
                .apply(OPTIONS)
                .into(aninImg);
        BezierAnimation.addCart(this,mRlAddShopCart,mIconShopCart,aninImg,this);
    }
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        ...
        mCircleTextView.setCicleBackground(Color.RED);
        initData();
        initTabLayout();
    }
