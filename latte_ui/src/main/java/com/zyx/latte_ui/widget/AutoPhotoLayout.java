package com.zyx.latte_ui.widget;
...
public class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //设置一行所有图片的宽高
        Log.d("paddingwidth", String.valueOf(width + getPaddingLeft() + getPaddingRight()));
        Log.d("sizewidth", String.valueOf(sizeWidth));
        Log.d("removeWidth", String.valueOf(sizeWidth - getPaddingLeft() - getPaddingRight()));

        int sizefinalWidth = sizeWidth-getPaddingLeft()-getPaddingRight();
        final int imageSideLen = sizefinalWidth / mMaxLineNum;
        //只初始化一次
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            lineHeight = Math.max(childHeight, lineHeight + lp.topMargin + lp.bottomMargin);
