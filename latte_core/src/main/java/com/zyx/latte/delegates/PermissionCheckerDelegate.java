...
import com.zyx.latte.ui.camera.CameraImaegBean;
import com.zyx.latte.ui.camera.LatteCamera;
import com.zyx.latte.ui.camera.RequestCodes;
...
public abstract class PermissionCheckerDelegate extends BaseDelegate {
    ...
    void onCameraRationable(PermissionRequest request) {
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case RequestCodes.TAKE_PHOTO:
                    final Uri resultUri = CameraImaegBean.getInstance().getPath();
